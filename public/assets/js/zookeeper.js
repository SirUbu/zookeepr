const $zookeeperFrom = document.querySelector('#zookeeper-form');
...
const handleGetZookeeperSubmit = event => {
  ...
  const nameHTML = $zookeeperFrom.querySelector('[name="name"]');
  const name = nameHTML.value;

  const ageHTML = $zookeeperFrom.querySelector('[name="age"]');
...
$zookeeperFrom.addEventListener('submit', handleGetZookeeperSubmit);
